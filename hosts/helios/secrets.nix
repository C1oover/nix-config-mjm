{
  ...
  # libvirtd vm
  vault-secrets.encryptedSecretId = ''
    Whxqht+dQJax1aZeCGLxmiAAAAABAAAADAAAABAAAABKYHkLs1FjpujqlU4AAAAApae1XFfVPFEs15r
    EtNVng2PbMIyUds65t3OPRij76WkvZoSf4zgy2chLbl9zhX5CSJuv2S8A1kwtnajqZalu3xSmQ8cGKN
    78ALja+lThkdwTrFlp
  '';
}
