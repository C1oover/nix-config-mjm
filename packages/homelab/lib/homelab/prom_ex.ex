defmodule Homelab.PromEx do
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: HomelabWeb.Router, endpoint: HomelabWeb.Endpoint},
      # Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:homelab, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
