defmodule HomelabWeb.HomeLive.Index do
  ...
  def app_link(assigns) do
    ...
    <li class="col-span-1 flex shadow-sm sm:rounded-md">
      ...
      <div class="flex-1 flex items-center justify-between border-t border-r border-b border-gray-200 bg-white sm:rounded-r-md truncate">
        <div class="flex-1 px-4 py-2 text-sm truncate">
          <a href={@href} target="_blank" class="text-gray-900 font-medium hover:text-gray-600">
            <%= render_slot(@title) %>
          </a>
